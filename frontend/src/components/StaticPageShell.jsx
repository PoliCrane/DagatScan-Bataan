export function StaticPageShell({ title, children }) {
  return (
    <div className="static-page-shell public-page-offset w-full px-4 py-6 sm:px-6 md:px-10 md:py-10">
      <div className="mx-auto max-w-4xl">
        <div
          className="relative mb-8 overflow-hidden rounded-card border p-10 text-center shadow-card md:mb-10"
          style={{
            background:
              "radial-gradient(90% 220% at 12% 0%, rgba(56, 189, 248, 0.18), transparent 62%), linear-gradient(90deg, #0a1e38 0%, #061428 100%)",
